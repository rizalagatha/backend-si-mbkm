...
const createBerkasPenilaian = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Berkas Penilaian created successfully', berkasPenilaian });
  } catch (error) {
...
const getBerkasPenilaianById = async (req, res) => {
  ...
  try {
    ...
    if (berkasPenilaian) {
      ...
      res.status(404).json({ message: 'Berkas Penilaian not found' });
    }
  } catch (error) {
    res.status(500).json({ message: error.message });
  }
...
const updateBerkasPenilaian = async (req, res) => {
  ...
  try {
    ...
    if (updated) {
      ...
      res.status(200).json({ message: 'Berkas Penilaian updated successfully', updatedBerkasPenilaian });
    } else {
      res.status(404).json({ message: 'Berkas Penilaian not found' });
    }
  } catch (error) {
...
const deleteBerkasPenilaian = async (req, res) => {
  ...
  try {
    ...
    if (deleted) {
      res.status(204).json({ message: 'Berkas Penilaian deleted successfully' });
    } else {
      res.status(404).json({ message: 'Berkas Penilaian not found' });
    }
  } catch (error) {
